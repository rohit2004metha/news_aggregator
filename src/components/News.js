...
capitalizeFirstLetter=(string)=>{
  ...
  render() {
    return (
      <div className='container my-3' style={{ backgroundColor: 'blue' }}> {/* Set your desired background color */}
      <h1 className="text-center" style={{ margin: '70px 0px' }}>NewsMonkey-Top {this.capitalizeFirstLetter(this.props.category)} Headlines</h1>
